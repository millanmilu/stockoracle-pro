...
const ALL_SCRIPTS = [
  ...
  { id: 'ema_20', name: 'Exponential Moving Average (EMA)', type: 'overlay', category: 'technicals', tab: 'Indicators', desc: 'Weighted moving average giving highest importance to latest price action.' },
  { id: 'boll', name: 'Bollinger Bands (BB 20, 2)', type: 'overlay', category: 'technicals', tab: 'Indicators', desc: '3-line volatility bands: Upper, Middle Baseline (20 SMA), and Lower Band.' },
  { id: 'alma', name: 'Arnaud Legoux Moving Average (ALMA)', type: 'overlay', category: 'technicals', tab: 'Indicators', desc: 'Gaussian-filtered moving average with ultra-low lag and smooth curve.' },
  { id: 'rsi_14', name: 'Relative Strength Index (RSI)', type: 'oscillator', category: 'technicals', tab: 'Indicators', desc: 'Momentum oscillator with 70 Overbought, 50 Midline, and 30 Oversold benchmarks.' },
  { id: 'macd', name: 'MACD (12, 26, 9)', type: 'oscillator', category: 'technicals', tab: 'Indicators', desc: 'Moving Average Convergence Divergence with MACD Line, Signal Line, and colored Histogram.' },
