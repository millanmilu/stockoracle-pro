...
export const ALL_COLUMNS = [
  ...
  { key: 'macd_hist', label: 'MACD Hist', group: 'technical', numeric: true, format: 'dec2' },
  ...
  { key: 'ai_confidence_score', label: 'AI Conf', group: 'ai', numeric: true, format: 'dec1' },
...
export function columnsForGroup(groupId) {
  if (!groupId || groupId === 'all') return ALL_COLUMNS;
