...
export const INDICATOR_DEFINITIONS = [
  ...
  // ── Keltner & Donchian Channels ──────────────────────────────────────────────
  {
    ...
    description: 'Volatility envelope based on 20 EMA baseline and 2x ATR channel bands.',
    badge: 'Channels',
  },
  {
    id: 'donchian',
  ...
  },
  {
    ...
    lineWidth: 1.5,
    field: 'obv',
    description: 'Volume flow indicator measuring institutional accumulation and distribution.',
    badge: 'Volume',
  },
  ...
  },
  {
    ...
    color: '#06B6D4',
    field: 'mfi',
    description: 'Volume-weighted momentum index (0-100 scale) for buying and selling pressure.',
    badge: 'Volume',
  },
  {
    id: 'stoch',
    ...
    field: 'stoch_k',
    signalField: 'stoch_d',
    description: 'Stochastic momentum indicator tracking %K and %D signal crossovers.',
    badge: 'Momentum',
  },
  {
    id: 'cci',
    ...
    color: '#F97316',
    field: 'cci',
    description: 'Measures deviation from historical statistical average.',
    badge: 'Oscillator',
  },
  {
    id: 'williams_r',
    ...
    color: '#EC4899',
    field: 'williams_r',
    description: 'Momentum indicator oscillating between -100 (oversold) and 0 (overbought).',
    badge: 'Oscillator',
  },
  {
    id: 'macd',
