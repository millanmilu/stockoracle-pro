...
const SHORTCUT_GROUPS = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { key: 'Space (in Replay)', desc: 'Play / Pause Bar Replay auto-advance' },
      { key: '→ / ← (in Replay)', desc: 'Step forward / backward 1 bar' },
      { key: 'Shift + → / ←', desc: 'Step forward / backward 10 bars' },
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { key: '1 – 0', desc: 'Activate pinned favourite drawing tool (star tools in any flyout to pin)' },
      { key: 'Click empty chart', desc: 'Deselect the selected drawing' },
