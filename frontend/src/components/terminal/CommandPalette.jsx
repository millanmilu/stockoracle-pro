...
const COMMANDS = [
  ...
  { cmd: '/intel',   desc: 'Open Market Intelligence Hub (Multi-Source News, Fear/Greed, Sentiment TA)', view: 'Market Intelligence', icon: Newspaper },
  { cmd: '/sentiment', desc: 'Open Sentiment TA & Price Divergence Studio', view: 'Sentiment TA', icon: Activity },
